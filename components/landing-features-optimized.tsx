...
export function LandingFeaturesOptimized() {
    ...
    >
      ...
      <div className="container relative z-10">
            ...
            >
              ...
              >
                <CardContent className="p-6 relative z-10">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white transition-all duration-300">
                    {feature.title}
                  </h3>
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} transition-opacity duration-500 ${hoveredIndex === index ? "opacity-5" : "opacity-0"}`}
                />
              </Card>
            </div>
          ))}
        ...
        <div className="text-center mt-20">
          ...
          <button className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 hover:scale-105">
            Get Started Free
          </button>
        </div>
      </div>
