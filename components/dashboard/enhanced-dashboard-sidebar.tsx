...
export function EnhancedDashboardSidebar({ onItemClick }: EnhancedDashboardSidebarProps) {
  const pathname = usePathname()

  return (
    <div className="w-full h-full">
      <div className="w-full h-full border-r border-white/10 bg-gradient-to-b from-slate-900 via-slate-900/95 to-slate-800 relative overflow-hidden">
          ...
          <div className="mt-auto">
            <div className="relative rounded-2xl bg-gradient-to-br from-purple-600/20 to-cyan-600/20 border border-white/10 backdrop-blur-sm p-6 overflow-hidden">
              ...
              <div className="relative flex flex-col space-y-4">
                ...
                <Link href="/dashboard/subscription" onClick={onItemClick}>
