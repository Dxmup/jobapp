...
export default function InterviewPrepPage() {
  ...
  const handleMockInterviewClick = () => {
    ...
    // Navigate directly to mock interview with interview type
              ...
              <div className="space-y-3 pt-4 border-t border-purple-200">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="phone-screener" className="text-sm">
                      Phone Screener (15 min) - Quick qualification check
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="first-interview" id="first-interview" />
                    <Label htmlFor="first-interview" className="text-sm">
                      First Interview (30 min) - In-depth behavioral & technical
                    </Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              {selectedJob && (
                <div className="bg-white/50 p-3 rounded-lg border border-purple-200">
                  ...
                  <p className="text-xs text-purple-600 mt-1">
                    {interviewType === "phone-screener" ? "15-minute screening" : "30-minute interview"}
                  </p>
                </div>
              )}
