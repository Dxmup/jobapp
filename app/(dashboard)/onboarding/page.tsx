...
export default function OnboardingPage() {
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    // Extract first name from full name using utility function
    const firstName = extractFirstName(profileData.fullName)
    ...
    try {
      ...
      const response = await fetch("/api/user/profile", {
        ...
        body: JSON.stringify({
          ...profileData,
          firstName: firstName, // Add the extracted first name
        }),
      })
