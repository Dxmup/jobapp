...
import { AutoMigrationRunner } from "@/components/admin/auto-migration-runner"
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "This admin panel provides powerful tools to manage the CareerAI platform, users, and content."
            </p>
            <footer className="text-sm">CareerAI Team</footer>
          </blockquote>
        </div>
      </div>
