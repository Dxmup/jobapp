...
export async function GET() {
  try {
    ...
    // First, try to fetch testimonials
    ...
    if (error && error.message.includes('relation "public.testimonials" does not exist')) {
      console.log("Testimonials table doesn't exist, returning empty array")
